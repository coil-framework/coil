...
use coil_assets::{AssetDeliveryTarget, ContentFingerprint, FingerprintAlgorithm, RevisionId};
use coil_auth::{
    AuthModelPackage, AuthModelPackageSelection, Capability, CoilAuth, DefaultSubject,
...
use coil_cache::{CacheInstant, InvalidationSet, InvalidationTag};
use coil_commerce::EntitlementKey;
use coil_config::{DatabaseConfig, PlatformConfig, StorageClass};
use coil_core::validate_module_capabilities;
use coil_data::{
...
use coil_jobs::{DeadLetterReason, JobFailureDisposition, JobInstant, QueueKind};
...
fn usage() -> String {
    [
        ...
        "  coil auth bindings inspect [--config <path>] [--capability <capability>] [--json]",
        "  coil auth test-model <spec-path> [--config <path>] [--json]",
        "  coil auth list [--config <path>] --subject <subject> --relation <relation> --namespace <namespace> [--json]",
        "  coil auth lookup [--config <path>] --resource <namespace:id> --relation <relation> --subject-namespace <namespace> [--json]",
        "  coil auth explain [--config <path>] --subject <subject> --capability <capability> --resource <namespace:id> [--json]",
        "  coil auth package validate [--config <path>] [--json]",
        "  coil auth package inspect [--config <path>] [--json]",
        "  coil module list [--config <path>] [--json]",
        "  coil module inspect <module> [--config <path>] [--json]",
        "  coil module install <module> [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil module enable <module> [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil module disable <module> [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil migrate plan [--config <path>] [--json]",
        "  coil migrate apply [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil release doctor [--config <path>] [--json]",
        "  coil release plan [--config <path>] [--json]",
        "  coil cache warm [--config <path>] --scope public --route <path> [--route <path> ...] [--dry-run] [--json]",
        "  coil cache inspect [--config <path>] --route <path> [--json]",
        "  coil cache invalidate [--config <path>] --tag <tag> [--tag <tag> ...] [--dry-run] --yes [--json]",
        "  coil jobs status [--config <path>] [--queue <name>] [--json]",
        "  coil jobs run [--config <path>] [--queue <name>] [--worker-id <id>] [--limit <n>] [--dry-run] [--json]",
        "  coil jobs ready [--config <path>] [--queue <name>] [--limit <n>] [--json]",
        "  coil jobs dead-letters [--config <path>] [--queue <name>] [--limit <n>] [--json]",
        "  coil jobs in-flight [--config <path>] [--queue <name>] [--worker-id <id>] [--limit <n>] [--json]",
        "  coil jobs retry <dead-letter-id> [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil jobs promote [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil tls status [--config <path>] [--json]",
        "  coil tls validate-challenge [--config <path>] [--json]",
        "  coil tls renew [--config <path>] --certificate <id> --replacement <id> [--dry-run] [--yes] [--json]",
        "  coil storage inspect [--config <path>] [--json]",
        "  coil storage verify [--config <path>] [--policy] [--json]",
        "  coil assets publish [--config <path>] [--dry-run] [--yes] [--json]",
        "  coil import run <manifest-path> [--dry-run] [--json]",
        "  coil import cutover <manifest-path> [--apply] [--yes] [--legacy-freeze-confirmed] [--json]",
        "  coil import cutover <manifest-path> --switch --base-url <url> [--dry-run] [--dns-zone-id <zone> --dns-target <hostname> | --switch-zone-id <zone> --switch-resource-id <id> --switch-target <target>] [--yes] [--json]",
        "  coil import cutover <manifest-path> --observe --base-url <url> --yes [--json]",
        "  coil import cutover <manifest-path> --rollback --base-url <url> --reason <text> --yes [--json]",
        "",
        "Examples:",
        "  coil dev server --config config/platform.toml",
        "  coil config validate --config config/platform.toml",
        "  coil auth check --subject user:alice --capability cms.page.publish --resource page:homepage",
        "  coil auth bindings inspect --config config/platform.toml --capability cms.page.publish",
        "  coil auth test-model config/auth-model.toml --config config/platform.toml",
        "  coil auth list --config config/platform.toml --subject user:alice --relation view --namespace page",
        "  coil auth lookup --config config/platform.toml --resource page:homepage --relation view --subject-namespace user",
        "  coil auth explain --subject user:alice --capability cms.page.publish --resource page:homepage",
        "  coil auth package validate --config config/platform.toml",
        "  coil auth package inspect --config config/platform.toml",
        "  coil module list --config config/platform.toml",
        "  coil module inspect cms --config config/platform.toml",
        "  coil module install media --config config/platform.toml --dry-run",
        "  coil module enable media --config config/platform.toml --dry-run",
        "  coil module disable media --config config/platform.toml --dry-run",
        "  coil migrate plan --config config/platform.toml",
        "  coil migrate apply --config config/platform.toml --dry-run",
        "  coil release doctor --config config/platform.toml",
        "  coil release plan --config config/platform.toml",
        "  coil cache warm --config config/platform.toml --scope public --route /en-GB/home",
        "  coil cache inspect --config config/platform.toml --route /en-GB/home",
        "  coil cache invalidate --config config/platform.toml --tag route:events.list --tag locale:en-GB --yes",
        "  coil jobs status --config config/platform.toml",
        "  coil jobs run --config config/platform.toml --worker-id worker-a --limit 25",
        "  coil jobs ready --config config/platform.toml --queue jobs.work --limit 25",
        "  coil jobs dead-letters --config config/platform.toml --queue jobs.dead-letter --limit 25",
        "  coil jobs in-flight --config config/platform.toml --queue jobs.work --worker-id worker-a --limit 25",
        "  coil jobs retry dead-letter:job-retry --config config/platform.toml --dry-run",
        "  coil jobs promote --config config/platform.toml --dry-run",
        "  coil tls status --config config/platform.toml",
        "  coil tls validate-challenge --config config/platform.toml",
        "  coil tls renew --config config/platform.toml --certificate cert-live --replacement cert-next --dry-run",
        "  coil storage inspect --config config/platform.toml",
        "  coil storage verify --config config/platform.toml --policy",
        "  coil assets publish --config apps/shoppr/platform.toml --dry-run",
        "  coil import run imports/wordpress-events.toml",
        "  coil import run imports/wordpress-events.toml --dry-run",
        "  coil import cutover imports/wordpress-events.toml",
        "  coil import cutover imports/wordpress-events.toml --apply --yes --legacy-freeze-confirmed",
        "  coil import cutover imports/wordpress-events.toml --switch --base-url https://shop.example.com --dns-zone-id zone_123 --dns-target coil-origin.example.net --yes",
        "  coil import cutover imports/wordpress-events.toml --switch --base-url https://shop.example.com --switch-zone-id zone_123 --switch-resource-id lb-edge-1 --switch-target coil-origin-pool --dry-run",
        "  coil import cutover imports/wordpress-events.toml --observe --base-url https://shop.example.com --yes",
        "  coil import cutover imports/wordpress-events.toml --rollback --base-url https://shop.example.com --reason \"edge routing failed\" --yes",
        "  coil import cutover imports/wordpress-events.toml --rollback --base-url https://shop.example.com --reason \"systemic auth failure\" --yes",
        "",
        "Environment:",
        "  COIL_COOKIE_SECRET and COIL_CSRF_SECRET are required for `dev server`",
...
fn build_live_auth_backend(
    ...
    (
        PlatformConfig,
        CoilAuth<zanzibar::postgres::PostgresRebacEngine>,
...
> {
    ...
    let auth = CoilAuth::new(engine, config.auth.tenant_id);
...
fn load_auth_package_from_app_root(
    app_root: &Path,
    package_name: &str,
) -> Result<coil_auth::LoadedAuthModelPackage, CliRunError> {
...
fn supported_official_module_manifest(
    module: &str,
) -> Result<coil_core::ModuleManifest, CliRunError> {
    let module: Box<dyn coil_core::PlatformModule> = match module {
        ...
        "ops" => Box::new(coil_ops::OpsModule::new()),
        other => {
            return Err(CliRunError::execution(format!(
...
fn run_jobs_ready(invocation: &JobsReadyInvocation) -> Result<CommandReport, CliRunError> {
    ...
    let (runtime, host) = build_cli_jobs_host(&built, "coil-jobs-ready", "ready")?;
    let _runtime_guard = runtime.enter();
...
fn build_jobs_ready_report(
    app_id: &str,
    topology: &coil_jobs::QueueTopology,
    backend: coil_config::JobBackend,
    default_retry_limit: u32,
    ready_jobs: &[coil_jobs::QueuedJobRecord],
...
fn run_jobs_run(
    ...
    let worker_id = invocation
        .worker_id
        .clone()
        .unwrap_or_else(|| format!("coil-jobs-run:{}", built.manifest.id));
    let mut report = CommandReport::new(
        ["jobs", "run"],
        if dry_run {
            format!(
    ...
    let (runtime, mut host) = build_cli_jobs_host(&built, "coil-jobs-run", "run")?;
    let _runtime_guard = runtime.enter();
...
fn executable_jobs_queues(
    ...
    topology: &coil_jobs::QueueTopology,
    queue_filter: Option<&str>,
) -> Result<Vec<coil_jobs::JobQueueName>, CliRunError> {
    if let Some(filter) = queue_filter {
        let known_queues = topology
            .queues
            .iter()
...
fn run_jobs_in_flight(invocation: &JobsInFlightInvocation) -> Result<CommandReport, CliRunError> {
        ...
        live_jobs_state_unavailable_reason(&built, &probe_runtime, "inspect in-flight job state")?
    {
        ...
        let (runtime, host) = build_cli_jobs_host(&built, "coil-jobs-in-flight", "in-flight")?;
        let _runtime_guard = runtime.enter();
        let now_unix_seconds = unix_timestamp_now()?;
        let mut leases = host
            .coordinator()
...
fn run_jobs_retry(
    ...
    let (runtime, mut host) = build_cli_jobs_host(&built, "coil-jobs-retry", "retry")?;
    let _runtime_guard = runtime.enter();
...
fn run_jobs_promote(
    ...
    let (runtime, mut host) = build_cli_jobs_host(&built, "coil-jobs-promote", "promote")?;
    let _runtime_guard = runtime.enter();
    let due_jobs = host
        .coordinator()
        .scheduled_jobs()
...
fn run_tls_status(config_path: &Path) -> Result<CommandReport, CliRunError> {
    ...
    if built.runtime_plan.runtime.tls.mode == coil_config::TlsMode::External {
        let mut report = CommandReport::new(
            ["tls", "status"],
...
fn resolve_cache_route_execution(
    built: &BuiltCustomerAppContext,
    route: &str,
) -> Result<(coil_runtime::RequestExecution, String), CliRunError> {
...
fn cache_backend_availability_error(built: &BuiltCustomerAppContext) -> Option<String> {
    match built.runtime_plan.runtime.config.cache.l2 {
        Some(coil_config::DistributedCache::Redis) if std::env::var("REDIS_URL").is_err() => {
            Some("redis cache backend requires REDIS_URL to be set".to_string())
        }
        Some(coil_config::DistributedCache::Valkey)
...
fn render_cache_warm_value(
    runtime: &coil_runtime::RuntimePlan,
    execution: &coil_runtime::RequestExecution,
...
struct EvaluatedImportCutover {
    ...
    cutover: coil_import::ImportCutover,
...
const CLOUDFLARE_API_BASE_URL_ENV: &str = "COIL_CLOUDFLARE_API_BASE_URL";
const CUTOVER_CLOUDFLARE_SECRET_ENV: &str = "COIL_CUTOVER_CLOUDFLARE_SECRET";
const CUTOVER_SYNTHETIC_SESSION_ENV: &str = "COIL_CUTOVER_ALLOW_SYNTHETIC_SESSION";
...
fn run_import_cutover(invocation: &ImportCutoverInvocation) -> Result<CommandReport, CliRunError> {
    ...
    if !cutover_preflight_ready(&evaluated.cutover_plan) {
        return Err(CliRunError::execution(format!(
            "cutover `{}` is not executable yet; rerun `coil import cutover {}` to inspect the blocking readiness checks",
...
fn switch_import_cutover(
    ...
    match journal.state {
        coil_import::CutoverExecutionState::Prepared
        | coil_import::CutoverExecutionState::SwitchConfirmed
        | coil_import::CutoverExecutionState::Observing
        | coil_import::CutoverExecutionState::ObservationPassed
        | coil_import::CutoverExecutionState::RollbackRequired => {}
        _ => {
            return Err(CliRunError::execution(format!(
                "cutover `{}` must be prepared with `coil import cutover {} --apply --yes` before switch confirmation",
                evaluated.manifest.run_id,
                invocation.manifest_path.display()
            )));
        }
...
impl CloudflareCredentials {
    ...
    fn headers(&self) -> Result<HeaderMap, CliRunError> {
        ...
        Err(CliRunError::execution(
            "Cloudflare DNS switch requires API credentials from `tls.account_secret` or `COIL_CUTOVER_CLOUDFLARE_SECRET`".to_string(),
        ))
    }
}
...
fn observe_import_cutover(
    ...
    match journal.state {
        ...
        _ => {
            return Err(CliRunError::execution(format!(
                "cutover `{}` must be switched with `coil import cutover {} --switch --base-url <url> --yes` before observation can start",
                evaluated.manifest.run_id,
                invocation.manifest_path.display()
            )));
        }
...
fn rollback_import_cutover(
    ...
    match journal.state {
        ...
        | coil_import::CutoverExecutionState::ObservationPassed
        | coil_import::CutoverExecutionState::RollbackRequired
        | coil_import::CutoverExecutionState::RolledBack => {}
        _ => {
            return Err(CliRunError::execution(format!(
...
fn evaluate_verification_readiness(
    verification: &coil_import::ImportVerification,
    built: &BuiltCustomerAppContext,
...
fn execute_cutover_observation_probe(
    ...
    client: &BlockingHttpClient,
    base_url: &str,
    verification: Option<&coil_import::ImportVerification>,
...
fn issue_cutover_observation_session_cookie(
    ...
    let cookie_secret = read_runtime_secret("COIL_COOKIE_SECRET")?;
    let csrf_secret = read_runtime_secret("COIL_CSRF_SECRET")?;
...
fn build_dev_server_runtime_plan(
    config_path: &Path,
) -> Result<coil_runtime::RuntimePlan, CliRunError> {
...
fn ensure_dev_server_home_route(
    plan: &mut coil_runtime::RuntimePlan,
    app_root: &Path,
) -> Result<(), CliRunError> {
...
fn build_assets_publish_report(
    manifest: &CustomerAppManifest,
    active_manifest: &coil_assets::ActiveAssetManifest,
    receipt: Option<&coil_assets::ThemeAssetPublicationReceipt>,
    dry_run: bool,
) -> Result<CommandReport, CliRunError> {
    let summary = if dry_run {
        format!(
...
fn storage_policy_label(plan: &coil_storage::StoragePlan) -> String {
    format!(
        "{:?}/{:?}/{:?}",
...
fn build_import_auth_context(
    ...
    let engine = zanzibar::postgres::PostgresRebacEngine::new(client.pool.clone());
    let auth = CoilAuth::new(engine, runtime.built.runtime_plan.runtime.tenant_id());
...
fn materialize_import_assets(
    ...
    manifest_root: &Path,
    runtime: &BuiltImportRuntimeContext,
    execution: &coil_import::ImportExecution,
) -> Result<(), CliRunError> {
...
fn materialize_asset_record(
    storage_host: &StorageHost,
    asset_storage_default: coil_import::AssetStorageDefault,
    manifest_root: &Path,
...
fn ensure_import_data_client(
    data_runtime: &coil_data::DataRuntime,
...
fn import_data_model_error(error: coil_data::DataModelError) -> ImportModelError {
    ImportModelError::ManifestParse {
        message: error.to_string(),
    }
}
...
fn import_membership_model_error(
    error: coil_memberships::MembershipModelError,
) -> ImportModelError {
    ImportModelError::ManifestParse {
        message: error.to_string(),
    }
...
fn storage_override_for_import_default(
    ...
    let policy = StoragePolicy::from(match asset_storage_default {
        coil_import::AssetStorageDefault::PublicUpload => StorageClass::PublicUpload,
        coil_import::AssetStorageDefault::PrivateShared => StorageClass::PrivateShared,
        coil_import::AssetStorageDefault::LocalOnlySensitive => StorageClass::LocalOnlySensitive,
    });
...
fn parse_auth_capability_spec(
    input: &str,
    field: &str,
) -> Result<coil_auth::Capability, CliRunError> {
    coil_auth::Capability::from_str(input).ok_or_else(|| {
        CliRunError::execution(format!(
...
fn environment_label(environment: coil_config::Environment) -> &'static str {
    match environment {
...
fn storage_deployment_label(deployment: coil_config::StorageDeployment) -> &'static str {
    match deployment {
        coil_config::StorageDeployment::Distributed => "distributed",
        coil_config::StorageDeployment::SingleNode => "single_node",
    }
}
...
"#;
    ...
    fn customer_app_fixture_with_rendered_config(
        ...
        let suffix = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let root = std::env::temp_dir().join(format!("coil-cli-workflow-{suffix}"));
    ...
    fn configure_dns_cutover_for_import_fixture(_fixture: &ImportFixture) -> DnsCutoverTestContext {
        ...
        let suffix = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let dns_target = "coil-origin.example.net".to_string();
    ...
    fn import_fixture() -> ImportFixture {
        ...
        let suffix = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let root = std::env::temp_dir().join(format!("coil-cli-import-{suffix}"));
        let config_dir = root.join("config");
        let app_root = root.join("apps").join("showcase-events");
        let templates_root = app_root.join("templates").join("pages");
        let storage_root = root.join("storage");
        let object_store_server = ObjectStoreTestServer::spawn();
        let object_store_env_var = format!("COIL_IMPORT_OBJECT_STORE_URL_{suffix}");
        let manifest_path = root.join("imports").join("wordpress-events.toml");
        let journal_path = import_journal_path(
            &manifest_path,
            &coil_import::ImportRunId::new("wordpress-events").unwrap(),
        );
...
"#
    ...
    fn customer_app_fixture_with_assets(publish_manifest: bool) -> CustomerAppAssetFixture {
        let suffix = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let root = std::env::temp_dir().join(format!("coil-cli-assets-{suffix}"));
        let config_dir = root.join("config");
        let app_root = root.join("apps").join("showcase-events");
        let templates_root = app_root.join("templates").join("pages");
        ...
        let object_store_server = ObjectStoreTestServer::spawn();
        let object_store_env_var = format!("COIL_OBJECT_STORE_URL_{suffix}");

        fs::create_dir_all(&config_dir).unwrap();
        fs::create_dir_all(&templates_root).unwrap();
        fs::create_dir_all(&asset_root).unwrap();
        let mut config =
            DISABLED_EXPLAIN_CONFIG.replace("/tmp/coil-cli", &local_root.display().to_string());
    ...
    fn run_from_args_returns_usage_for_help() {
        ...
        assert!(rendered.contains("coil config validate [--config <path>]"));
        assert!(rendered.contains("coil auth check [--config <path>]"));
        assert!(rendered.contains("coil auth bindings inspect [--config <path>]"));
        assert!(rendered.contains("coil auth test-model <spec-path> [--config <path>]"));
        assert!(rendered.contains("coil auth list [--config <path>]"));
        assert!(rendered.contains("coil auth lookup [--config <path>]"));
        assert!(rendered.contains("coil auth explain [--config <path>]"));
        assert!(rendered.contains("coil auth package inspect [--config <path>]"));
        ...
        assert!(rendered.contains("coil assets publish [--config <path>] [--dry-run] [--yes]"));
        assert!(rendered.contains("coil import run <manifest-path> [--dry-run]"));
        assert!(rendered.contains("coil import cutover <manifest-path>"));
    }

    #[test]
    fn run_from_args_reports_live_auth_check_backend_initialization_failures() {
        let config_path = PathBuf::from("/tmp/coil-cli-auth-check.toml");
    ...
    fn run_from_args_reports_live_auth_check_config_load_failures_as_backend_initialization_failures()
     {
        let config_path = PathBuf::from("/tmp/coil-cli-missing-auth-check.toml");
    ...
    fn run_from_args_reports_live_auth_list_backend_initialization_failures() {
        let config_path = PathBuf::from("/tmp/coil-cli-auth-list.toml");
        fs::write(&config_path, DISABLED_EXPLAIN_CONFIG).unwrap();
    ...
    fn run_from_args_reports_live_auth_lookup_backend_initialization_failures() {
        let config_path = PathBuf::from("/tmp/coil-cli-auth-lookup.toml");
        fs::write(&config_path, DISABLED_EXPLAIN_CONFIG).unwrap();
    ...
    fn run_from_args_reports_live_auth_test_model_backend_initialization_failures() {
        let config_path = PathBuf::from("/tmp/coil-cli-auth-test-model.toml");
        let spec_path = PathBuf::from("/tmp/coil-cli-auth-test-model-spec.toml");
        fs::write(&config_path, DISABLED_EXPLAIN_CONFIG).unwrap();
        fs::write(
            &spec_path,
            r#"
...
"#,
    ...
    fn load_auth_model_test_document_rejects_empty_specs() {
        let spec_path = PathBuf::from("/tmp/coil-cli-auth-empty-spec.toml");
    ...
    fn run_from_args_renders_auth_bindings_for_the_configured_package() {
        ...
        assert!(rendered.contains("coil-default-auth"));
    ...
    fn run_from_args_reports_disabled_auth_explain_from_live_config() {
        let config_path = PathBuf::from("/tmp/coil-cli-disabled.toml");
        fs::write(&config_path, DISABLED_EXPLAIN_CONFIG).unwrap();
    ...
    fn run_from_args_reports_live_auth_explain_config_load_failures_as_backend_initialization_failures()
     {
        let config_path = PathBuf::from("/tmp/coil-cli-missing-auth-explain.toml");
    ...
    fn local_webhook_verification_supports_matching_runtime_handlers() {
        let verification = coil_import::ImportVerification::default()
            .with_required("webhook_failures")
            .unwrap()
            .with_webhook(
                coil_import::ImportWebhookVerification::new(
    ...
    fn webhook_observation_ignores_events_before_the_observation_window() {
        let verification = coil_import::ImportVerification::default().with_webhook(
            coil_import::ImportWebhookVerification::new(
                "commerce.payment-provider",
                "payment.authorized",
            )
        ...
        let snapshot = WebhookObservationSnapshot {
            backend: coil_runtime::WebhookObservationBackendKind::LocalSqlite,
            location: "local-sqlite:test".to_string(),
            path: None,
            entry_count: 2,
            status_counts: coil_runtime::WebhookObservationStatusCounts {
    ...
    fn run_from_args_validates_config_and_renders_a_report() {
        let config_path = PathBuf::from("/tmp/coil-cli-config-validate.toml");
        fs::write(&config_path, DISABLED_EXPLAIN_CONFIG).unwrap();
    ...
    fn run_from_args_renders_migrate_apply_dry_run_for_executable_module_migrations() {
        ...
        assert!(rendered.contains("auth:coil-default-auth"));
        assert!(rendered.contains("customer_app:showcase-events"));
    ...
    fn build_jobs_ready_report_keeps_normal_backlog_at_ok_status() {
        ...
        let job_id = coil_jobs::JobId::new("job:ready-probe").unwrap();
        let job_name = coil_jobs::JobName::new("ops.search.reindex".to_string()).unwrap();
        let ready_jobs = vec![coil_jobs::QueuedJobRecord {
            spec: coil_jobs::JobSpec::new(
                job_id.clone(),
                job_name.clone(),
            ...
            .unwrap()
            .with_idempotency_key(coil_jobs::IdempotencyKey::new("cli_ready_probe").unwrap()),
            attempts: 1,
            enqueued_at: now,
        }];
    ...
    fn run_from_args_renders_live_jobs_in_flight_for_leased_jobs() {
        ...
        let rendered = {
            ...
            let Ok(mut host) = built
                .runtime_plan
                .runtime
                .jobs_host("coil-jobs-in-flight-seed")
            else {
                return;
            };
            let definition = host
                ...
                .find(|definition| {
                    matches!(
                        ...
                        coil_core::JobTriggerKind::Operator
                            | coil_core::JobTriggerKind::Webhook
                            | coil_core::JobTriggerKind::InlineFollowup
                    )
                })
                .cloned()
                .expect("fixture runtime should register a leaseable job");
            let mut request = coil_runtime::JobDispatchRequest::new(
    ...
    fn run_from_args_renders_tls_validate_challenge_for_cloudflare_origin_customer_app() {
        ...
        let config_path = customer_app_fixture_with_tls_config(
            "[tls]\nmode = \"cloudflare-origin\"\nprovider = \"cloudflare-origin-ca\"\naccount_secret = { kind = \"env\", var = \"COIL_TLS_VALIDATE_CHALLENGE_SECRET\" }",
        );
        unsafe {
            std::env::set_var(
                "COIL_TLS_VALIDATE_CHALLENGE_SECRET",
        ...
        unsafe {
            std::env::remove_var("COIL_TLS_VALIDATE_CHALLENGE_SECRET");
            std::env::remove_var("COIL_TLS_MATERIAL_KEY");
        }
