const GITLY = (() => {
  const translations = {
    "en-GB": {
      ...
      footer: "Gitly is a customer-root Coil demo showing CMS, custom API surfaces, linked Rust hooks, and runtime-installed WASM.",
      ...
      copy: {
        ...
        "home.title": "One Coil app can look like a forge, not just a storefront.",
        ...
        "explore.summary": "Trending demo surfaces show how Coil can present developer products, docs, and automation under one customer app.",
        ...
        "repo.summary": "Accessible multilingual UI primitives and customer-app examples for Coil.",
        "repo.readmeTitle": "README",
        "repo.readmeBody": "Gitly demonstrates a customer-owned workspace using Coil as an upstream dependency. Linked Rust hooks govern editorial policy, custom routes expose GitHub-like APIs, and bounded WASM packages extend selected runtime surfaces.",
        ...
        "org.summary": "A fictional product engineering group showing reusable branding, developer workflows, and docs operations on Coil.",
        ...
        "search.result.repo": "Accessible multilingual UI primitives and customer-app examples for Coil.",
    ...
    "fr-FR": {
      ...
      footer: "Gitly est une démo Coil en espace client montrant le CMS, des API sur mesure, des hooks Rust liés et du WASM installé à l'exécution.",
      ...
      copy: {
        ...
        "home.title": "Une application Coil peut ressembler à une forge, pas seulement à une boutique.",
        ...
        "explore.summary": "Les surfaces tendance montrent comment Coil peut présenter produits développeur, documentation et automatisation dans une seule application client.",
        ...
        "repo.summary": "Primitives UI accessibles et multilingues ainsi qu’exemples d’applications clientes pour Coil.",
        "repo.readmeTitle": "README",
        "repo.readmeBody": "Gitly montre un espace de travail client qui consomme Coil comme dépendance amont. Les hooks Rust liés gouvernent la politique éditoriale, des routes personnalisées exposent des API de style GitHub, et des paquets WASM bornés étendent certaines surfaces d’exécution.",
        ...
        "org.summary": "Un groupe fictif d’ingénierie produit montrant image de marque réutilisable, flux développeur et opérations de documentation sur Coil.",
        ...
        "search.type.actions": "Actions",
        "search.result.repo": "Primitives UI accessibles et multilingues ainsi qu’exemples d’applications clientes pour Coil.",
    ...
    "de-DE": {
      ...
      footer: "Gitly ist eine Coil-Demo im Customer-Root-Workspace mit CMS, eigenen APIs, eingebundenen Rust-Hooks und zur Laufzeit installiertem WASM.",
      ...
      copy: {
        ...
        "home.title": "Eine Coil-Anwendung kann wie eine Forge aussehen, nicht nur wie ein Store.",
        ...
        "explore.summary": "Trendflächen zeigen, wie Coil Entwicklerprodukte, Dokumentation und Automatisierung in einer Kundenanwendung bündeln kann.",
        ...
        "repo.summary": "Zugängliche mehrsprachige UI-Bausteine und Customer-App-Beispiele für Coil.",
        "repo.readmeTitle": "README",
        "repo.readmeBody": "Gitly zeigt einen kunden-eigenen Workspace, der Coil als Upstream-Abhängigkeit nutzt. Eingebundene Rust-Hooks steuern redaktionelle Richtlinien, eigene Routen liefern GitHub-artige APIs und begrenzte WASM-Pakete erweitern ausgewählte Laufzeitflächen.",
        ...
        "org.summary": "Ein fiktives Produktteam, das wiederverwendbares Branding, Entwicklerabläufe und Dokumentationsbetrieb auf Coil zeigt.",
        ...
        "search.type.person": "Profil",
        "search.type.actions": "Actions",
        "search.result.repo": "Zugängliche mehrsprachige UI-Bausteine und Customer-App-Beispiele für Coil.",
  ...
  const searchIndex = [
    { type: "repo", route: "repo", title: "forgeflow/platform-ui", summaryKey: "search.result.repo", terms: ["platform", "repo", "ui", "rust", "coil", "accessibility", "multilingual"] },
