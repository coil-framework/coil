...
fn file_delivery_mode_name(mode: super::FileDeliveryMode) -> &'static str {
    match mode {
        super::FileDeliveryMode::PublicCdn => "public_cdn",
        super::FileDeliveryMode::SignedUrl => "signed_url",
        super::FileDeliveryMode::AppProxy => "app_proxy",
        super::FileDeliveryMode::LocalOnly => "local_only",
    }
}
