...
pub(super) fn typed_node(node: &GraphNode) -> Result<ExplainedNode, DavendaAuthError> {
...
pub(super) fn typed_tuple(tuple: &Tuple) -> Result<DefaultTuple, DavendaAuthError> {
...
pub(super) fn parse_relation(relation: &str) -> Result<Relation, DavendaAuthError> {
