  ...
  const translations = {
    "en-GB": {
      ...
      copy: {
        ...
        "home.summary": "OctoHub is a multilingual, theme-switchable, accessible demo with linked Rust business rules, custom API endpoints, and runtime-installed WASM.",
        ...
        "repo.readmeBody": "OctoHub demonstrates a customer-owned workspace using Davenda as an upstream dependency. Linked Rust hooks govern editorial policy, custom routes expose GitHub-like APIs, and bounded WASM packages extend selected runtime surfaces.",
    ...
    "fr-FR": {
      ...
      copy: {
        ...
        "home.summary": "OctoHub est une démo multilingue, accessible et à thèmes commutables avec logique Rust liée, API personnalisées et WASM borné.",
        ...
        "repo.readmeTitle": "README",
        "repo.readmeBody": "OctoHub montre un espace de travail client qui consomme Davenda comme dépendance amont. Les hooks Rust liés gouvernent la politique éditoriale, des routes personnalisées exposent des API de style GitHub, et des paquets WASM bornés étendent certaines surfaces d’exécution.",
    ...
    "de-DE": {
      ...
      copy: {
        ...
        "home.summary": "OctoHub ist eine mehrsprachige, zugängliche und themenumschaltbare Demo mit eingebundener Rust-Logik, eigenen APIs und begrenztem WASM.",
        ...
        "repo.readmeTitle": "README",
        "repo.readmeBody": "OctoHub zeigt einen kunden-eigenen Workspace, der Davenda als Upstream-Abhängigkeit nutzt. Eingebundene Rust-Hooks steuern redaktionelle Richtlinien, eigene Routen liefern GitHub-artige APIs und begrenzte WASM-Pakete erweitern ausgewählte Laufzeitflächen.",
