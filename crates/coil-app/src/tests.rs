...
use coil_assets::ReleaseId;
use coil_auth::{Capability, DefaultAuthModelPackage};
...
<html xmlns:coil="https://coil.rs" coil:fragment="shell" coil:attr="lang=${locale}">
  ...
  <body>
    ...
    fs::write(
        ...
        r#"<section xmlns:coil="https://coil.rs" coil:fragment="hero">Hero</section>"#,
    )
    .unwrap();
    workspace
}
...
fn extension_package() -> ExtensionPackage {
    ExtensionPackage::new(
        ...
        ExtensionManifest::new(
            coil_wasm::ExtensionId::new("loyalty-widget").unwrap(),
            "Loyalty Widget",
            ContractVersion::new(1, 2, 3),
            ContractVersion::new(1, 0, 0),
            ResourceLimits::baseline_for(coil_wasm::ExtensionPointKind::RenderHook),
            vec![
                HandlerManifest::new(
                    HandlerId::new("account.loyalty.widget").unwrap(),
    ...
    vec![
        ModuleManifest::new("cms")
            ...
            .with_route_surfaces(vec![RouteSurface::new(
                "cms.page",
                coil_core::RouteSurfaceKind::FrontendPage,
                "/pages/{slug}",
            )])
            .with_jobs(vec![JobContract::new(
                "cms.publish-scheduled",
                coil_core::JobTriggerKind::Scheduled,
                true,
            ...
            .with_extension_slots(vec![coil_core::ExtensionSlotDescriptor::new(
                coil_core::ExtensionSlotKind::RenderHook,
                "cms.page.render",
        ...
        ModuleManifest::new("commerce")
            ...
            .with_module_dependencies(vec![coil_core::ModuleDependency::required(
                "cms",
...
impl PlatformModule for StaticModule {
    ...
    ) -> Result<(), coil_core::RegistrationError> {
        Ok(())
    }
...
fn customer_app_can_build_a_runtime_plan_from_selected_modules() {
    ...
    assert!(
        runtime
            ...
            .any(|entry| matches!(
                entry.owner,
                MigrationPlanOwner::AuthPackage(ref package) if package == "coil-default-auth"
            ))
    );
    assert!(
        runtime
